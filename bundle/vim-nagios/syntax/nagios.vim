...
syn keyword nagiosDirective contained contacts contact_groups contactgroups contact_name contactgroup_name
syn keyword nagiosDirective contained dependent_host_name dependent_service_description dependent_servicegroup_name dependent_hostgroup_name
